...
level1 = new Level(
    ...
    new ThrowableObject(670, topPosition,hoveringBottle),
    new ThrowableObject(1220, topPosition,hoveringBottle),
    new ThrowableObject(1300, topPosition,hoveringBottle),
    new ThrowableObject(1500, groundPosition, groundBottle),
    new ThrowableObject(1600, topPosition,hoveringBottle),
    new ThrowableObject(2500, topPosition,hoveringBottle),
    new ThrowableObject(2650, groundPosition, groundBottle),
    ],[
    new CollectibleObject(300, topPosition),
    new CollectibleObject(370, topPosition),
    new CollectibleObject(440, topPosition),
    new CollectibleObject(1640, bottomPosition),
    new CollectibleObject(1710, bottomPosition),
    new CollectibleObject(1780, bottomPosition),
